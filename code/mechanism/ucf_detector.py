...
from .spsa_modules import SPSA, SPSAPlaceholder
...
class UCFDetector(AbstractDetector):
    def __init__(self, config):
        ...
        # conditional gan
        self.con_gan = Conditional_UNet(use_spsa=config.get('spsa', False), spsa_mode=config.get('spsa_mode', 'spsa'))
...
class Conditional_UNet(nn.Module):
    ...
    def __init__(self, use_spsa=False, spsa_mode='spsa'):
        ...
        if use_spsa:
            self.spsa = SPSA(128, 128) if spsa_mode == 'spsa' else SPSAPlaceholder(128, 128)
